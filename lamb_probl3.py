...
print("This is linear_velocity_y_1")
print(linear_velocity_y_1)
...
# CHANGE ME
# ------------------------
# t_maneuver = 1/2 * t1 + 3*t1
t_maneuver = 0.8 * t1
print("t_maneuver")
print(t_maneuver)
# dv = [0.3, 0.5, 0] * u.km / u.s
# ------------------------
